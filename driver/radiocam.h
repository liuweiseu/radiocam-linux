...
struct radiocam_version {
    ...
    __u32 minor;
    __u32 patch;
    __u32 fw_major;    /* MCU firmware version (read from DEV_ID_DEBUG) */
    __u32 fw_minor;
    __u32 fw_patch;
};
...
#define RADIOCAM_DEV_DEBUG           0x01
#define RADIOCAM_DEBUG_VERSION_REG   0x01  /* read returns FW_VERSION_WORD */
